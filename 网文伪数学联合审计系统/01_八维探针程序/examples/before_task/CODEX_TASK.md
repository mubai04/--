...
```powershell
python "pseudo_linear_probe.py" score --task "examples/before_task/task.json" --extraction "examples/before_task/extraction.json" --output "examples/before_task/probe.report.json"
```

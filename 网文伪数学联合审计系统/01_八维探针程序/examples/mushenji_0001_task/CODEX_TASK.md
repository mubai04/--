...
```powershell
python "01_八维探针程序\pseudo_linear_probe.py" score --task "01_八维探针程序\examples\mushenji_0001_task\task.json" --extraction "01_八维探针程序\examples\mushenji_0001_task\extraction.json" --output "01_八维探针程序\examples\mushenji_0001_task\probe.report.json"
```

...
```powershell
python "pseudo_linear_probe.py" score --task "examples/after_task/task.json" --extraction "examples/after_task/extraction.json" --output "examples/after_task/probe.report.json"
```
